...
//Loop for get histograms and make the comparison.
    TString histnames[]={Form("hf-task-%s/hptcand",task.Data()),Form("hf-task-%s/hptprong0",task.Data()),Form("hf-task-%s/hptprong1",task.Data()),Form("hf-task-%s/hptprong2",task.Data()),Form("hf-task-%s/hmass",task.Data()),Form("hf-task-%s/hCPA",task.Data()),Form("hf-task-%s/hCt",task.Data()),Form("hf-task-%s/hEta",task.Data()),Form("hf-task-%s/hdeclength",task.Data())};
	for (int i = 0; i<9; i++){
